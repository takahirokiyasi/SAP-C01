...
### S3低頻度アクセス (1ゾーン - IA)
1ゾーンなので可用性は低い
それほど通常のS3と料金が変わらないが問題的にコスト削減でIAを選ばないといけない時もある（予想問題集によって異なる。重要性が高いデータとか言ってる場合は避ける）
...
バケットポリシーが出る前にあった機能
公開するけどこのオブジェクトだけ公開したくないとかの場合オブジェクトACLが使える。
[バケットポリシーとACLとの組み合わせによる許可・不許可](https://dev.classmethod.jp/articles/s3-acl-wakewakame/#toc-4)
